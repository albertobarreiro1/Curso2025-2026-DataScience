...
Original file is located at
    https://colab.research.google.com/drive/112HDt6Sv4Mv2DhfSFlTTcKkhhzax4IVH
...
"""**TASK 6.1: Reproduce the taxonomy of classes shown in slide 34 in class (all

1.   Elemento de lista
2.   Elemento de lista

the classes under "Vocabulario", Slidedeck: 01a.RDF(s)-SPARQL). Add labels for each of them as they are in the diagram (exactly) with no language tags. Remember adding the correct datatype (xsd:String) when appropriate**
