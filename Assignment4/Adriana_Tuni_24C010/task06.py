...
Original file is located at
    https://colab.research.google.com/drive/1OOsU11Af_kSE2EQErtCc6S2xHo1S7R4B
...
associate = Persona.AssociateProfessor
...
interim = Persona.InterimAssociateProfessor
...
hasColleague = Persona.hasColleague
...
hasHomePage = Persona.hasHomePage
...
g.add((DATA.Oscar, RDF.type, full))
g.add((DATA.Oscar, RDFS.label, Literal("Oscar", datatype=XSD.string)))
g.add((DATA.Oscar, hasColleague, DATA.Asun))
g.add((DATA.Oscar, hasName, Literal("Oscar García", datatype=XSD.string)))


g.add((DATA.Asun, RDF.type, full))
g.add((DATA.Asun, RDFS.label, Literal("Asun", datatype=XSD.string)))
g.add((DATA.Asun, hasColleague, DATA.Oscar))
g.add((DATA.Asun, hasHomePage, Literal("https://www.oeg-upm.net/", datatype=XSD.string)))


g.add((DATA.Raul, RDFS.label, Literal("Raul", datatype=XSD.string)))
g.add((DATA.Raul, RDF.type, interim))
...
g.add((DATA.Oscar, vcard.Family, Literal("García", datatype=XSD.string)))
g.add((DATA.Oscar, foaf.email, Literal("ocorcho@upm.es", datatype=XSD.string)))
# Visualize the results
for s, p, o in g:
  print(s,p,o)
