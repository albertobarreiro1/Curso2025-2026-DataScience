...
Original file is located at
    https://colab.research.google.com/drive/1hkCzEcTR8uFrbWaRKSejKV4fIecRZIF4
...
query = """
PREFIX link: <http://oeg.fi.upm.es/def/people#>
SELECT DISTINCT ?name WHERE {
  ?person link:ownsPet ?m .
  { ?name link:hasColleague ?person }
  UNION
  {
    ?person2 link:hasColleague ?person .
    ?name link:hasColleague ?person2 .
  }
}
"""
